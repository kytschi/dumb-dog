...
class Icons
{
    ...
    public function delete()
    {
        ...
        <svg width='32px' height='32px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
            ...
            <path d='M 11.884531,7.7390176 V 19.003802 m 0,0 4.224294,-4.224294 m -4.224294,4.224294 -4.2242942,-4.224294' stroke='#1c274c' stroke-width='1.05607' stroke-linecap='round' stroke-linejoin='round' id='path529' />
        </svg>";
    }
